                    ...
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item active">Slide show & ads
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">INPUT SLIDE</h4>
                                </div>
                                <form id="formadd">
                                    @csrf
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-xl-6 col-md-6 col-12 mb-1">
                                                <div class="form-group">
                                                    <label for="basicInput">Mini Title</label>
                                                    <input type="text" class="form-control" name="mini_title"
                                                        id="basicInput" placeholder="Mini Title" />
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-md-6 col-12 mb-1">
                                                <div class="form-group">
                                                    <label for="helpInputTop">Long Title</label>
                                                    <input type="text" class="form-control" name="long_title"
                                                        id="helpInputTop" placeholder="Long Title" />
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-md-6 col-12 mb-1">
                                                <label for="customFile">Image Slide</label>
                                    ...
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-header border-bottom">
                                                <h4 class="card-title">Table Slide show & ads</h4>
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-md-6 col-12 mb-1">
                                <div class="form-group">
                                    ...
                                    <label for="basicInput">Mini Title</label>
                                    <input type="text" class="form-control" name="mini_title" id="mini_title"
                            ...
                            <div class="col-xl-6 col-md-6 col-12 mb-1">
                                <div class="form-group">
                                    <label for="helpInputTop">Long Title</label>
                                    <input type="text" class="form-control" name="long_title" id="long_title"
...
@section('script')
    ...
    <script>
        $('#modaledit').on('show.bs.modal', function(event) {
            ...
            var mini_title = button.data('mini_title')
            var long_title = button.data('long_title')
            var src = button.data('src')
            var modal = $(this)
            modal.find('.modal-content #id').val(id);
            modal.find('.modal-content #mini_title').val(mini_title);
            modal.find('.modal-content #long_title').val(long_title);
        ...
        $('#formdel').submit(function(e) {
            ...
            $.ajax({
                ...
                beforeSend: function() {
                    ...
                    $('#btndel').val('Process Deleting Slide show & ads');
                },
