    ...
    <nav class="header-navbar navbar-expand-lg navbar navbar-fixed align-items-center navbar-shadow navbar-brand-center" data-nav="brand-center">
        ...
        <div class="navbar-container d-flex content">
            ...
            <ul class="nav navbar-nav align-items-center ml-auto">
               <?php $pesan = App\Models\Message::all();
                     $belum_dibaca = App\Models\Message::where('status','belum dibaca')->get();
               ?>
                <li class="nav-item dropdown dropdown-notification mr-25"><a class="nav-link" href="javascript:void(0);" data-toggle="dropdown"><i class="ficon" data-feather="bell"></i><span class="badge badge-pill badge-danger badge-up">{{$belum_dibaca->count()}}</span></a>
                    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                        <li class="dropdown-menu-header">
                            <div class="dropdown-header d-flex">
                                <h4 class="notification-title mb-0 mr-auto">Notif</h4>
                                @if ($belum_dibaca->count() > 0)
                                <div class="badge badge-pill badge-light-primary">{{$belum_dibaca->count()}} New messages</div>
                                @endif
                                
                            </div>
                        </li>
                        <li class="scrollable-container media-list">
                            @foreach ($belum_dibaca as $item)
                            <a class="d-flex" href="javascript:void(0)">
                                <div class="media d-flex align-items-start">
                                    ...
                                    <div class="media-body">
                                        <p class="media-heading"><span class="font-weight-bolder">{{$item->name}} 🎉</span>{{$item->email}}!</p><small class="notification-text">{{substr($item->deskripsi,0,20)}}...</small>
                                    </div>
                                </div>
                            </a>
                            @endforeach
                ...
                <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        </span><span class="user-status">Admin</span></div><span class="avatar"><img class="round" src="../../../app-assets//images/portrait/small/avatar-s-11.jpg" alt="avatar" height="40" width="40"><span class="avatar-status-online"></span></span>
                    </a>
            ...
            <ul class="nav navbar-nav align-items-center ml-auto">
                ...
                <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link"
                        ...
                        <div class="user-nav d-sm-flex d-none"><span class="user-name font-weight-bolder">
                            ...
                            Tes
                            @endauth
                        </span><span class="user-status">Admin</span></div><span
                            class="avatar">
                            @auth
                                ...
                                @else
                                <img class="round"
                                src="{{asset('img/team/'.auth()->user()->team->img)}}" alt="avatar"
                                height="40" width="40">  
                                @endif
                            @endauth
                ...
                <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                    <li class="dropdown nav-item" data-menu="dropdown"><a
                            ...
                            data-toggle="dropdown"><i data-feather="home"></i><span
                                data-i18n="Dashboards">Messages</span></a>
                        <ul class="dropdown-menu">
                            <li data-menu=""><a class="dropdown-item d-flex align-items-center"
                                    href="{{route('message.page')}}" data-toggle="dropdown" data-i18n="Analytics"><i
                                        ></i><span data-i18n="Analytics">Incoming Messages</span></a>
                            </li>
                            <li data-menu=""><a class="dropdown-item d-flex align-items-center"
                                href="{{route('choice.page')}}" data-toggle="dropdown" data-i18n="Analytics"><i
                                    ></i><span data-i18n="Analytics">Multiple Choice</span></a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="dropdown nav-item" data-menu="dropdown"><a
                            ...
                            data-toggle="dropdown"><i data-feather="edit"></i><span
                                data-i18n="Forms &amp; Tables">Forms</span></a>
                        <ul class="dropdown-menu">
                            <li data-menu=""><a class="dropdown-item d-flex align-items-center"
                                    href="{{ route('slider.page') }}" data-toggle="dropdown" data-i18n="Form Layout"><i
                                        data-feather="box"></i><span data-i18n="Form Layout">Slide show & ads</span></a>
                            </li>
                        </ul>
                    </li>
                    <li class="dropdown nav-item" data-menu="dropdown"><a
                            class="dropdown-toggle nav-link d-flex align-items-center" href="#"
                            data-toggle="dropdown"><i data-feather="file-text"></i><span data-i18n="Pages">About
                                Us</span></a>
                        <ul class="dropdown-menu">
                            <li data-menu=""><a class="dropdown-item d-flex align-items-center"
                                    href="{{ route('profile.page') }}" data-toggle="dropdown" data-i18n="Profile"><i
                                        data-feather="user"></i><span data-i18n="Profile">Profile</span></a>
                            </li>
                            <li data-menu=""><a class="dropdown-item d-flex align-items-center"
                                    href="{{ route('about.page') }}" data-toggle="dropdown" data-i18n="Profile"><i
                                        data-feather="file-text"></i><span data-i18n="Profile">Aout Us</span></a>
                            </li>
                        </ul>
                    </li>
                    <li class="dropdown nav-item" data-menu="dropdown"><a
                            ...
                            data-toggle="dropdown"><i data-feather="bar-chart-2"></i><span
                                data-i18n="Charts &amp; Maps">Product</span></a>
                        <ul class="dropdown-menu">
                            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                                    class="dropdown-item d-flex align-items-center" href="{{ route('jenis.page') }}"
                                    data-i18n="Charts"><i data-feather="pie-chart"></i><span data-i18n="Charts">Jenis
                                        Product</span></a>
                            </li>
                            <li data-menu=""><a class="dropdown-item d-flex align-items-center"
                                    href="{{ route('product.page') }}" data-toggle="dropdown" data-i18n="eCommerce"><i
                                        data-feather="shopping-cart"></i><span data-i18n="eCommerce">Product</span></a>
                            </li>
                        </ul>
                    </li>
                    <li class="dropdown nav-item" data-menu="dropdown"><a
                            class="dropdown-toggle nav-link d-flex align-items-center" href="#"
                            data-toggle="dropdown"><i data-feather="user"></i><span data-i18n="Pages">Team</span></a>
                        <ul class="dropdown-menu">
                            <li data-menu=""><a class="dropdown-item d-flex align-items-center"
                                    href="{{ route('team.page') }}" data-toggle="dropdown" data-i18n="Profile"><i
                                        data-feather="user"></i><span data-i18n="Profile">My Team</span></a>
                            </li>
                        </ul>
                    </li>
                </ul>
